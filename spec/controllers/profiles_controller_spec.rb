...
RSpec.describe ProfilesController, type: :controller do
  ...
  let(:valid_attributes) {
    {bio: FFaker::Lorem.paragraph(2), user_id: user.id}
  }
  ...
  describe "GET #show" do
    it "assigns the requested profile as @profile" do
      profile = Profile.create! valid_attributes
      get :show, params: {user_id: user.id, id: profile.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested profile as @profile" do
      profile = Profile.create! valid_attributes
      get :edit, params: {user_id: user.id, id: profile.to_param}, session: valid_session
      expect(assigns(:profile)).to eq(profile)
    end
  end
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved profile as @profile" do
        post :create, params: {user_id: user.id, profile: invalid_attributes}, session: valid_session
        expect(assigns(:profile)).to be_a_new(Profile)
      end
